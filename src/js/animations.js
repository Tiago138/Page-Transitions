...
export default function PageTransitions() {
  ...
  function productLeaveAnimation(current, done, gradient) {
  ...
  barba.init({
    ...
    transitions: [
      ...
      // Enter product page animation
      {
        name: "product-tansition",
        sync: true,
        from: {
          namespace: ["handbag", "boot", "hat"],
        },
        to: {
          namespace: ["product"],
        },
      ...
      // Leave product page animation
      {
        ...
        leave(data) {
          ...
          productLeaveAnimation(current, done, gradient);
        },
        enter(data) {
          const done = this.async();
          let next = data.next.container;
